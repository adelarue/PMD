...
"""
function evaluate(Y::Vector, df::DataFrame, 
					# model::Union{DataFrame,DecisionTree.Root,DecisionTree.Ensemble,Chain,GreedyModel,XGBoost.Booster,Tuple{Any, DataFrame}};
					model::Union{DataFrame,Chain,GreedyModel,XGBoost.Booster,Tuple{Any, DataFrame},PyCall.PyObject};
...
function evaluate(Y::BitArray{1}, df::DataFrame, 
				# model::Union{DataFrame,DecisionTree.Root,DecisionTree.Ensemble,Chain,GreedyModel,XGBoost.Booster,Tuple{Any, DataFrame}};
				model::Union{DataFrame,Chain,GreedyModel,XGBoost.Booster,Tuple{Any, DataFrame},PyCall.PyObject};
